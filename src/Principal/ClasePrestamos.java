...
public class ClasePrestamos {
    ...
    public void eliminarPrestamo(String id_libro, String id_usuario, String fecha_prestamo, JTable table) {
        conexion.EliminaRegistro("prestamos", id_libro, id_usuario, fecha_prestamo);
